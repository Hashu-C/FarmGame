...
public class GamePanel extends JPanel implements ActionListener{
	...
	public void canPlant() {
		...
		int inUse = Plant.getPlantInUse();
		Plant temp = new Plant(x, y, 0);
		if(inUse==0){
             temp =new Plant("grass",x,y,1, 1, 0, 200, 0, 240, 5, 1, 3, 0);
        }
        if(inUse==1){
             temp =new Plant("rice",x,y,3, 3, 0, 0, 200, 240, 5, 5,3, 0);
        }
        if(inUse==2){
             temp =new Plant("sweet potato",x,y,2, 2, 200, 0, 0, 240, 5, 5,3, 0);
        }
        if(inUse==3){
             temp =new Plant("cabbage",x,y,3, 3, 0, 200, 0, 240, 5,5, 3, 0);
        }
        if(inUse==4){
             temp =new Plant("edamme",x,y,3, 3, 0, 200, 0, 240, 5,5, 3, 0);
        }
        if(inUse==5){
             temp =new Plant("papaya",x,y,3, 3, 0, 200, 0, 240, 5,5, 3, 0);
        }
        if(inUse==6){
             temp =new Plant("nectarines",x,y,3, 3, 0, 200, 0, 240, 5,5, 3, 0);
        }
		...
		if(vvalid && GameRunner.frame.moneyCount>=temp.sellPrice){
			
			GameRunner.frame.moneyCount-=temp.sellPrice;
    ...
    Plant zero = new Plant("grass",3, 3, 0, 200, 0, 240, 5,5, 3, 0);
